...
import { FileText, Zap, Clock, Shield, ArrowRight, Check, X } from 'lucide-react';
      ...
      <div className="max-w-9xl mx-auto bg-white border-8 border-gray-400 shadow-xl">
        ...
        <div className="grid grid-cols-[auto_1fr_auto] border-b border-gray-400">
          ...
          <div className="px-6 py-4 border-r border-gray-400 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 font-facultyGlyphic">InvoiceeAI</h1>
        ...
        <div className="border-b-2 border-gray-400 p-8 md:p-12 bg-gray-50">
          <div className="text-center mb-8">
            ...
            <h2 className="text-5xl md:text-7xl font-black text-gray-900 leading-none mb-6">
              Making your <span className="font-facultyGlyphic">Invoice</span><br />journey easier
            </h2>
        ...
        <div className="grid grid-cols-12 border-b border-gray-300">
          ...
          <div className="col-span-5 p-6 border-r border-gray-300">
            <h4 className="text-lg font-bold text-gray-900 mb-2">AI-Powered Generation</h4>
            <p className="text-sm text-gray-600">Intelligent invoice creation using advanced machine learning algorithms (not our&apos;s)</p>
          </div>
          <div className="col-span-3 p-6 border-r border-gray-300 flex items-center">
            <p className="text-sm font-medium text-gray-700">Save 10+ hours/week</p>
          </div>
        ...
        <div className="grid grid-cols-12 border-b border-gray-300 bg-gray-50">
          ...
          <div className="col-span-5 p-6 border-r border-gray-300">
            <h4 className="text-lg font-bold text-gray-900 mb-2">Lightning Fast Processing</h4>
            <p className="text-sm text-gray-600">Generate professional invoices in under 3 seconds*</p>
          </div>
          <div className="col-span-3 p-6 border-r border-gray-300 flex items-center">
            <p className="text-sm font-medium text-gray-700">99.9% faster than manual</p>
          </div>
          <div className="col-span-3 p-6 flex items-center">
        ...
        <div className="grid grid-cols-12 border-b border-gray-300">
          ...
          <div className="col-span-5 p-6 border-r border-gray-300">
            ...
            <p className="text-sm text-gray-600">Enterprise-level encryption and compliance standards</p>
          </div>
          <div className="col-span-3 p-6 border-r border-gray-300 flex items-center">
            <p className="text-sm font-medium text-gray-700">100% secure & compliant</p>
          </div>
          <div className="col-span-3 p-6 flex items-center">
        ...
        <div className="grid grid-cols-12 border-b-2 border-gray-400 bg-gray-50">
          ...
          <div className="col-span-5 p-6 border-r border-gray-300">
            ...
            <p className="text-sm text-gray-600">Fully customizable templates matching your brand identity</p>
          </div>
          <div className="col-span-3 p-6 border-r border-gray-300 flex items-center">
            <p className="text-sm font-medium text-gray-700">Professional appearance</p>
          </div>
          <div className="col-span-3 p-6 flex items-center">
        ...
        <div className="grid grid-cols-12 border-b border-gray-300 bg-gray-50">
          <div className="col-span-4 p-6 border-r border-gray-300">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="px-2 py-0.5 bg-blue-600 text-white text-xs font-bold">POPULAR</span>
            </div>
        ...
        <div className="grid grid-cols-12 border-b-2 border-gray-400">
          <div className="col-span-6 p-8 border-r-2 border-gray-400">
            <p className="text-xs font-bold text-gray-500 mb-3">PAYMENT TERMS</p>
            <p className="text-sm text-gray-700 mb-2">✓ No credit card required</p>
            <p className="text-sm text-gray-700 mb-2">✓ Cancel anytime</p>
            <p className="text-sm text-gray-700 mb-2">✓ 30-day money back guarantee</p>
          ...
          <div className="col-span-6 p-8 flex flex-col justify-center">
            ...
            <p className="text-center text-xs text-gray-500 font-medium">Due immediately • Free forever</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-12">
          <div className="col-span-6 p-6 border-r-2 border-gray-400">
            <p className="text-xs text-gray-500 mb-2">Questions? Contact us at:</p>
            <p className="text-sm font-bold text-gray-900">support@invoiceeai.com</p>
          ...
          <div className="col-span-6 p-6 text-right flex justify-center items-center">
            <h1 className="pointer-events-none bg-gradient-to-b from-black to-gray-300/80 bg-clip-text text-center text-7xl leading-none font-semibold whitespace-pre-wrap text-transparent dark:from-white dark:to-slate-900/10">INVOICEE-AI</h1>
          </div>
        </div>
      </div>
    </div>
