    ...
    <div className="sign-in-page h-screen w-screen flex justify-center items-center bg-blue-950 max-lg:p-5">
        <div className="sign-in-box h-fit w-fit rounded-lg shadow-2xl backdrop-blur-2xl flex flex-col items-center px-5 py-5 gap-5 bg-white max-sm:px-2">
            <div className="heading flex flex-col items-center">
                ...
                <p className='text-gray-500 font-poppins text-sm text-center w-3/4 max-sm:w-full max-sm:mt-2 mt-2'>Looks like its your first time, fill details to continue</p>
            </div>
            <GoogleButton/>
            ...
            <p className='font-facultyGlyphic border px-5 py-1 bg-blue-950 text-white rounded-lg mt-2'>Powered by InvoiceeAI</p>
        </div>
    </div>
  )
}
