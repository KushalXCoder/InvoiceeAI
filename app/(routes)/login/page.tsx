    ...
    <div className="h-screen w-full flex justify-between items-center">
        <div className="flex h-full w-2/4 border-r-2 justify-center items-center bg-white">
            <div className="flex flex-col">
                ...
                <p className='text-gray-600 font-poppins text-md w-5/6 max-sm:w-full max-sm:mt-2'>Welcome again, hope you are enjoing. Fill details to continue</p>
                <LoginForm />
                <p className="font-poppins text-md my-3">Don&apos;t have an account ?
