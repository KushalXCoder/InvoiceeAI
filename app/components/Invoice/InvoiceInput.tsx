...
const InvoiceInput = ({ screen }: { screen: string }) => {
  ...
  return (
    ...
    >
      <h1 className="font-poppins text-3xl max-lg:text-2xl">Invoice Details</h1>
      <form className="invoice-details w-full flex flex-col mt-5">
        {/* Primary Details */}
        <div className="primary-details flex flex-col">
          <h1 className="border border-gray-400 w-fit px-5 py-1 rounded-lg">
            Primary Details
          </h1>
        ...
        <div className="company-details flex flex-col mt-5">
          ...
          <div className="company-name flex flex-col gap-1 mt-3">
            <label htmlFor="companyName" className="text-[15px]">
              Company Name
            </label>
            <input
              type="text"
          ...
          <div className="addresses flex flex-col gap-2 mt-3">
            <div className="address-1 flex flex-col gap-1">
              <label htmlFor="address1" className="text-[15px]">
                Address 1
              </label>
              <input
                type="text"
            ...
            <div className="address-2 flex flex-col gap-1">
              <label htmlFor="address2" className="text-[15px]">
                Address 2
              </label>
              <input
                type="text"
            ...
            <div className="address-3 flex flex-col gap-1">
              <label htmlFor="address3" className="text-[15px]">
                Address 3
              </label>
              <input
                type="text"
        ...
        <div className="bill-to-details flex flex-col">
          <h1 className="border border-gray-400 w-fit px-5 py-1 rounded-lg mt-8">
            Bill To
          </h1>
          <div className="bill-to-company flex flex-col gap-1 mt-5">
            <label htmlFor="billToName" className="text-[15px]">
              Company Name
            </label>
            <input
              type="text"
          ...
          <div className="bill-to-addresses flex flex-col gap-2 mt-3">
            <div className="bill-address-1 flex flex-col gap-1">
              <label htmlFor="billToAddress1" className="text-[15px]">
                Address 1
              </label>
              <input
                type="text"
            ...
            <div className="bill-address-2 flex flex-col gap-1">
              <label htmlFor="billToAddress2" className="text-[15px]">
                Address 2
              </label>
              <input
                type="text"
            ...
            <div className="bill-address-3 flex flex-col gap-1">
              <label htmlFor="billToAddress3" className="text-[15px]">
                Address 3
              </label>
              <input
                type="text"
        ...
        <div className="other-details flex flex-col">
          ...
          <div className="notes-input flex flex-col gap-1 mt-5">
            ...
            <textarea
              name="notes"
              placeholder="If any notes write it here"
              rows={10}
              value={data.notes}
              onChange={handleChange}
          ...
          <div className="tnc-input flex flex-col gap-1 mt-5">
            <label htmlFor="tnc" className="text-[15px]">
